...
import io.rhonix.models.TaggedContinuation.TaggedCont.ScalaBodyRef
...
import io.rhonix.rholang.interpreter.RhoRuntime.{RhoISpace, RhoReplayISpace}
import io.rhonix.rholang.interpreter.RholangAndScalaDispatcher.RhoDispatch
import io.rhonix.rholang.interpreter.SystemProcesses._
import io.rhonix.rholang.interpreter.accounting.{_cost, Cost, CostAccounting, HasCost}
import io.rhonix.rholang.interpreter.registry.RegistryBootstrap
import io.rhonix.rholang.interpreter.storage.ChargingRSpace
...
import io.rhonix.rspace.internal.{Datum, Row, WaitingContinuation}
import io.rhonix.rspace.util.unpackOption
...
trait RhoRuntime[F[_]] extends HasCost[F] {
  ...
  /**
    * Parse the rholang term into [[io.rhonix.models.Par]] and execute it with provided initial phlo.
    *
    ...
    *                    [[io.rhonix.rholang.interpreter.errors.OutOfPhlogistonsError]] would return.
  ...
  /**
    ...
    * [[io.rhonix.rholang.interpreter.errors.OutOfPhlogistonsError]]. Because of that, use this
    ...
    * @param par [[io.rhonix.models.Par]] for the execution
...
object RhoRuntime {
  ...
  /**
    ...
    *                use [[io.rhonix.rholang.interpreter.accounting.noOpCostLog]]
    * @return
    */
  ...
  /**
    ...
    * @param extraSystemProcesses same as [[io.rhonix.rholang.interpreter.RhoRuntime.createRhoRuntime]]
    * @param initRegistry same as [[io.rhonix.rholang.interpreter.RhoRuntime.createRhoRuntime]]
    * @param costLog same as [[io.rhonix.rholang.interpreter.RhoRuntime.createRhoRuntime]]
    * @return
    */
